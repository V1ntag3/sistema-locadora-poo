...
import classesPrincipais.MinhaLocadora;
...
class TesteLocadora {
	...
	void testeCalcularAluguel() throws VeiculoJaCadastrado, VeiculoNaoCadastrado {
		...
		// Confirmando valor do aluguel do carro: (50(diária) + 1.64(seguro diario)) *
		// 5 dias = 258.22
		assertEquals(258.22, aluguelCarro, 0.01);
		// Confirmando valor do aluguel do caminhao: (70(diaria) + 6.58(seguro diario))
		// * 5 dias = 382.88
		assertEquals(382.88, aluguelCaminhao, 0.01);
		// Confirmando valor do aluguel do onibus: (60(diaria) + 16.44(seguro diario)) *
		// 5 dias = 382.19
	...
	@Test
	void testeRegistrarAluguel() throws VeiculoNaoCadastrado, VeiculoAlugado, ClienteNaoCadastrado, VeiculoJaCadastrado,
			ClienteJaCadastrado {
		MinhaLocadora locadora = new MinhaLocadora();
		Veiculo carro1 = new Carro("Estrela", "Antares", 1980, "A-100", 50, 20000, 1);
		Cliente cli1 = new Cliente("Zé Carlos", 1234);
	...
	@Test
	void testeRegistrarDevolucao() throws VeiculoJaCadastrado, ClienteJaCadastrado, VeiculoNaoCadastrado,
			VeiculoAlugado, ClienteNaoCadastrado, VeiculoNaoAlugado {
		MinhaLocadora locadora = new MinhaLocadora();
		Veiculo carro1 = new Carro("Estrela", "Antares", 1980, "A-100", 50, 20000, 1);
		Cliente cli1 = new Cliente("Zé Carlos", 1234);
		locadora.inserir(carro1);
	...
	@Test
	void testeFaturamentoTotal() throws VeiculoJaCadastrado, ClienteJaCadastrado, VeiculoNaoCadastrado, VeiculoAlugado,
	...
	@Test
	void testeQuantidadeTotalDeDiarias() throws VeiculoJaCadastrado, ClienteJaCadastrado, VeiculoNaoCadastrado,
			VeiculoAlugado, ClienteNaoCadastrado {
		MinhaLocadora locadora = new MinhaLocadora();
		Veiculo moto1 = new Moto("Estrela", "Andromeda", 1975, "X-911", 40, 15000, 50);
		Veiculo carro1 = new Carro("Estrela", "Antares", 1980, "A-100", 50, 20000, 1);
		Veiculo caminhao1 = new Caminhao("Estrela", "Betelgeuse", 1975, "S-123", 70, 30000, 200);
